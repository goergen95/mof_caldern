...
m = mapview::mapview(sections,zcol = "SpeciesSection", 
                     color = "black", 
...
lopt = leaflet::labelOptions(noHide = TRUE,
                    direction = 'top',
                    textOnly = TRUE)
l = mapview::addStaticLabels(m,label = as.character(sections$sectionID), labelOptions = lopt)
l
```
